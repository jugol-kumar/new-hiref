    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">Education List</h2>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                ...
                <table class="user-list-table table">
                    ...
                    <tr class="">
                        <th class="sorting">Education</th>
                        <th class="sorting">Edu-Label</th>
                        <th class="sorting">Actions</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="edu in educations.data" :key="edu.id">
                        <td>{{ edu.name }}</td>
                        <td>{{ edu.elabel.label }}</td>
                        <td>
                            <div class="demo-inline-spacing">
                                <button @click="deleteItemModal(edu.id)" type="button"
                ...
                <Pagination :links="educations.links" :from="educations.from" :to="educations.to" :total="educations.total" />
            </div>
    ...
    <Modal id="createNewSubCategory" title="Create New Sub Category" v-vb-is:modal>
        <form @submit.prevent="createNewSubCategory">
            <div class="modal-body">
                ...
                <div class="mb-1">
                    <v-select v-model="createForm.label_id" label="label" placeholder="Select Education Label" :options="eduLabels" :reduce="label => label.id"></v-select>
                </div>
                <label>Name: </label>
                <div class="mb-1">
