    ...
    <div :class="[classes.wrapper]" ref="taggable-select">
        ...
        <div class="relative text-left" :class="[classes.searchWrapper]">
            <div class="rounded bordered border-grey hover:border-blue">
                <ul :class="[isRequired]"
                    class="items-center flex flex-wrap list-reset pr-1 m-0 text-black w-full">
...
<script>
// import pointerScroll from "../../Store/pointerScroll";
export default {
    ...
    methods: {
        ...
        setOption(option) {
            ...
            this.$emit("inputTags", this.selectedOptions)
