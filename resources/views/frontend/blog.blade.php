            ...
            <div class="card mb-4 shadow-lg">
                <div class="row g-0">
                    ...
                    <a href="#" class="col-lg-8 col-md-12 col-12 bg-cover img-left-rounded"
                       style="background-image: url({{ asset("images") }}/placehoder.png);">
                        <img src="{{ asset("images") }}/placeholder.png" class="img-fluid d-lg-none invisible" alt=""></a>
                    <div class="col-lg-4 col-md-12 col-12">
                        <!-- Card body -->
                        <div class="card-body">
                            <a href="#" class="fs-5 mb-3 fw-semi-bold d-block">Category Name</a>
                            ...
                            <div class="row align-items-center g-0 mt-lg-7 mt-4">
                                ...
                                <div class="col lh-1 ">
                                    ...
                                    <p class="fs-6 mb-0">submit date</p>
                                </div>
                                <div class="col-auto">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-1.jpg" class="card-img-top rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body -->
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-8.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-4.jpg" class="card-img-top rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body-->
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-9.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-5.jpg" class="card-img-top rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body -->
                        <div class="card-body">
                            <a href="#" class="fs-5 fw-semi-bold d-block mb-3 text-danger ">Tutorial</a>
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-10.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-3.jpg" class="card-img-top rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body -->
                        <div class="card-body">
                            <a href="#" class="fs-5 fw-semi-bold d-block mb-3 text-primary">Workshop</a>
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-1.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                                    <h5 class="mb-1">Dustin Warren</h5>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-6.jpg" class="card-img-top rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body -->
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-2.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4 shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-3.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12">
                    ...
                    <div class="card mb-4 shadow-lg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-4.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-12 d-none d-lg-block">
                    <!-- Card -->
                    <div class="card mb-4 shadow-lg">
                        <a href="blog-single.html"  class="card-img-top"> <img src="{{ asset("frontend") }}/assets/images/blog/blogpost-2.jpg" class="img-fluid rounded-top-md"
                                                                               alt=""></a>
                        <!-- Card body -->
                        <div class="card-body">
                            <a href="#" class="fs-5 fw-semi-bold d-block mb-3 text-danger">Tutorial</a>
                            ...
                            <div class="row align-items-center g-0 mt-4">
                                <div class="col-auto">
                                    <img src="{{ asset("frontend") }}/assets/images/avatar/avatar-5.jpg" alt="" class="rounded-circle avatar-sm me-2">
                                </div>
                                <div class="col lh-1">
