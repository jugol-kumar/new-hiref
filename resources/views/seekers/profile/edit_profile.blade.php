                                    ...
                                    <form id="first_stepe">
                                        ...
                                        <div class="card mb-3 ">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label">Functional Address <span class="text-danger">*</span></label>
                                                ...
                                                <div class="mb-3" id="subCategoryCard" style="display: none">
                                                    <label for="id_label_multiple form-label">Functional Arias <span class="text-danger">*</span></label>
                                                ...
                                                <div class="mb-3">
                                                    <div class="row">
                                                        <div class="col">
                                                            <label class="form-label">Preferred State <span class="text-danger">*</span></label>
                                                            <small>(Change State for select city and p.s)</small>
                                                            <select class="selectpicker"
                                                                ...
                                                                @foreach($states as $state)
                                                                    <option value="{{ $state->id }}" {{ $user->seeker->division_id == $state->id ? 'selected' : '' }}>{{ $state->name }}</option>
                                                                @endforeach
                                                            </select>
                                                            @error('types')
                                                            <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="row">
                                                        <div class="col" id="upozila-card" style="display: none">
                                                            <label class="form-label">Job Places <span class="text-danger">*</span></label>
                                                    ...
                                                    <div class="row mt-3 align-items-center">
                                                        <label class="form-label">Expacted Salary <span class="text-danger">*</span></label>
                                                        <div class="col">
                                                            <input type="number" name="exp_min_sal" class="form-control" value="{{ $user->seeker->exp_min_sal }}"/>
                                                        </div>
                                                        <-->
                                                        <div class="col">
                                                            <input type="number" name="exp_max_sal" class="form-control" value="{{ $user->seeker->exp_max_sal }}"/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center mb-4 mb-lg-0 justify-content-between">
                                                        ...
                                                        <div class="">
                                                            <label>
                                                                <input type="radio" @if($user->seeker->gender === 'male') checked @endif  name="gender" value="male">
                                                            ...
                                                            <label>
                                                                <input  type="radio" @if($user->seeker->gender === 'female') checked @endif name="gender" value="female">
                                                                <div class="maleFemale btn-sık">
                                                                    <span>Female</span>
                                                                </div>
                                                            </label>
                                                ...
                                                <div class="mb-3">
                                                    <div class="d-flex align-items-center mb-4 mb-lg-0 justify-content-between">
                                                        ...
                                                        <div class="">
                                                            <label>
                                                                <input type="radio" @if($user->seeker->is_experienced === 'exp') checked @endif name="is_experienced" value="exp">
                                                                <div  class="maleFemale btn-sık">
                                                                    <span>Experienced</span>
                                                                </div>
                                                            </label>
                                                            <label>
                                                                <input  type="radio"  @if($user->seeker->is_experienced === 'fre') checked @endif  name="is_experienced" value="fre">
                                                                <div class="maleFemale btn-sık">
                                                                    <span>Fresher</span>
                                                                </div>
                                                            </label>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="input-group me-3">
                                                        <input class="form-control flatpickr flatpickr-input active"
                                                               type="text" value="{{ $user->seeker->declined_date }}"
                                                               name="declined_date"
                                            ...
                                            <div class="card-body ">
                                                <div class="mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <input type="text" name="company_name" class="form-control" value="{{ $user->seeker->company_name }}" />
                                                        </div>
                                                        <div class="col">
                                                            <input type="text" name="designation" class="form-control" value="{{ $user->seeker->designation }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="input-group me-3">
                                                                <input class="form-control flatpickr flatpickr-input active"
                                                                       type="text" value="{{ $user->seeker->start_date }}"
                                                                       name="start_date"
                                                                       aria-describedby="basic-addon2" readonly="readonly">
                                                        ...
                                                        <div class="col">
                                                            <div class="input-group me-3">
                                                                <input class="form-control flatpickr flatpickr-input active"
                                                                       type="text"  value="{{ $user->seeker->end_date }}"
                                                                       name="end_date"
                                                                       aria-describedby="basic-addon2" readonly="readonly">
                                                                <span class="input-group-text text-muted" id="basic-addon2"><i class="fe fe-calendar"></i></span>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="job_content" class="form-control" rows="5">
                                            ...
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <div class="col">
                                                        ...
                                                        <div class="col">
                                                            <input type="text" name="university" class="form-control" value="{{ $user->seeker->university }}" />
                                                        </div>
                                                        @error('university')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col">
                                                            <div class="input-group me-3">
                                                                <input class="form-control flatpickr flatpickr-input active"
                                                                       type="text"
                                                                       value="{{ $user->seeker->uni_start_date }}"
                                                                       name="uni_start_date"
                                                                       aria-describedby="basic-addon2" readonly="readonly">
                                                                <span class="input-group-text text-muted" id="basic-addon2"><i class="fe fe-calendar"></i></span>
                                                        ...
                                                        <div class="col">
                                                            <div class="input-group me-3">
                                                                <input class="form-control flatpickr flatpickr-input active"
                                                                       type="text"
                                                                       value="{{ $user->seeker->uni_end_date }}"
                                                                       name="uni_end_date"
                                                                       aria-describedby="basic-addon2" readonly="readonly">
                                                                <span class="input-group-text text-muted" id="basic-addon2"><i class="fe fe-calendar"></i></span>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="selectpicker" data-width="100%"
                                                                ...
                                                                @foreach($degrees as $deg)
                                                                    <option value="{{ $deg->id }}" {{ $deg->id == $user->seeker->education_label_id ? 'selected' : '' }}>{{ $deg->label }}</option>
                                                                @endforeach
                                                            </select>
