...
<!--            <div class="col-lg-3 col-md-12 col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-header border-bottom-0">
                <h3 class="h4 mb-0">Latest Jobs</h3>
            </div>
            <!-- Table -->
            <div class="table-responsive border-0">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="border-0" title="Job Status">J_status</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($jobs->take(10) as $key => $value)
                        @include('recruiters.jobs.single_job_row', ['see' => 'seeker'])
                    @endforeach
                    </tbody>
                </table>
            </div>
