...
@section('title', get_setting('name')." Recruiters Security")
    ...
    <div class="col-lg-9 col-md-8 col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="row" action="{{ route('recruiter.changeEmail') }}" method="post">
                    @csrf
                ...
                <div>
                    ...
                    <!-- Form -->
                    <form class="row" action="{{ route('recruiter.changePass') }}" method="post">
                        @csrf
